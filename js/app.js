    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".stages__slider")) new core(".stages__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".page__stages .swiper-button_prev",
                    nextEl: ".page__stages .swiper-button_next"
                },
                breakpoints: {
                    360: {
                        autoHeight: true
            ...
            if (document.querySelector(".types-heating__slider")) new core(".types-heating__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".types-heating__content .swiper-button_prev",
                    nextEl: ".types-heating__content .swiper-button_next"
                },
                breakpoints: {
                    360: {
                        slidesPerView: 1.333,
            ...
            if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
                ...
                loop: false,
                navigation: {
                    prevEl: ".reviews__slider .swiper-button_prev",
                    nextEl: ".reviews__slider .swiper-button_next"
                },
                on: {}
            });
        }
